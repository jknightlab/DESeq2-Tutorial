...
```{r load packages, warn.conflicts=F, quietly=T}
# Load libraries
...
```{r create-deseq-dataset, include=TRUE}
...
```{r filter-deseq-lowreads, include=TRUE}
...
```{r run-deseq-analysis, include=TRUE}
...
```{r save-normalised-data, include=TRUE}
...
```{r make-dispersion-plot, include=TRUE}
...
```{r extract-deseq-analysis, include=TRUE}
...
```{r variance-stabilizing-transformation, include=TRUE}
...
```{r plot-pca-batch-correction, include=TRUE}
...
```{r plot-dregs-heatmap, include=TRUE}
